...
Pred11_split <- data.frame(No = subset(train2,Task>12)[,"No"])
...
Pred11_split = merge(x = Pred11_split, y = s, by = "No")
Pred11_split <- Pred11_split[,-(1)]
...
prediction_score(ActualChoice2, Pred11_tgt)
prediction_score(ActualChoice2, Pred11_split)
```
...
Pred11_old <- data.frame(predict(model7_pre_male, newdata = V2young))
Pred11_young <- data.frame(predict(model7_pre, newdata = V2old))
Pred11_split <- data.frame(No = subset(train2,Task>12)[,"No"])
...
prediction_score(ActualChoice, Pred11_allages)
prediction_score(ActualChoice, Pred11_split)
```
